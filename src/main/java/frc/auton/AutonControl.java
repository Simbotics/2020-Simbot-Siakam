...
import frc.auton.mode.PreloadsPlusLineMiddle;
import frc.auton.mode.Test2;
import frc.auton.mode.TrenchTriangleBump;
import frc.auton.mode.TrenchTriangleBumpCloseToWall;
import frc.auton.mode.TrenchTriangleNoBump;
import frc.auton.mode.TrenchTriangleNoBumpCloseToWall;
...
public class AutonControl {
    ...
    private AutonControl() {
        ...
        step1.add(new TrenchTriangleBump());
        step1.add(new TrenchTriangleBumpCloseToWall());
        step1.add(new TrenchTriangleNoBump());
        step1.add(new TrenchTriangleNoBumpCloseToWall());

        step1.add(new Test2());
        
        step1.add(new DefaultMode()); // 0
        //step1.add(new PreloadsPlusLineMiddle());
